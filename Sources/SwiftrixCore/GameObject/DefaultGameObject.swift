...
/// Default concrete implementation of `GameObject` used by the engine core.
open class DefaultGameObject: GameObject {
    public let id = UUID()
    ...
    public func addChild(_ child: GameObject) {
        ...
        if let defaultChild = child as? DefaultGameObject {
    ...
    public func removeChild(_ child: GameObject) {
        ...
        if let defaultChild = child as? DefaultGameObject, defaultChild.parent === self {
