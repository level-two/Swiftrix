...
- **Data Model**: [data-model.md](data-model.md) defines `SpriteKitScene`, `NodeBinding`, `DirtySyncQueue`, Core `Camera` selection behavior, `DebugOverlayConfig`, and optional `TouchHitTestMap`.
