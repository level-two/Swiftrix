...
`GameObject` hierarchy, a small set of core components (`Script`, `View`,
...
├── data-model.md    # Core data structures (Scene, GameObject, components)
...
(Scene, GameObject, Components, Events, Physics, Input, Loop, Introspection) to
